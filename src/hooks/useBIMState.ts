...
import { snapToPrecisionLines } from '../math/polar';
import { analyzeDisassembly } from '../math/analysis';
...
export const useBIMState = () => {
  ...
  return {
    ...
    // @google/genai fix: Rename properties to match component expectations (e.g., LeftSidebar)
