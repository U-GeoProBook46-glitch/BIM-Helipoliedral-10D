...
// Import uuidv4 to resolve the reference error on line 33
...
const RightSidebar: React.FC<RightSidebarProps> = ({ stock, onSelect, selectedId, onAIGenerated }) => {
  ...
  const handleAIGenerate = async () => {
    ...
    try {
      // Create a new instance of GoogleGenAI before making the API call to ensure use of the current API key.
      ...
      // Access the generated text directly from the .text property (not a method).
      ...
      // Handle the case where the entity was not found (potentially due to API key issues)
